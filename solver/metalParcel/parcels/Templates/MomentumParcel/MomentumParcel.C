...
)
{
    ...
    bool isFixed = false;
    if (cloud.particleProperties().found("fixedParticle"))
    {
        isFixed = cloud.particleProperties().template lookup<bool>("fixedParticle");
    }
    else if (cloud.particleProperties().subOrEmptyDict("constantProperties").found("fixedParticle"))
    {
        isFixed = cloud.particleProperties().subOrEmptyDict("constantProperties").template lookup<bool>("fixedParticle");
    }
